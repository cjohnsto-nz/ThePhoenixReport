...
Th a t’s IT’s lot in life. At least we’re not in a dingy, dimly lit dank base-
...
```
Laura’s. It’s the same size as my boss’ office—or rather, my ex-boss’ of-
...
action, especially when it was so long ago. I smile in return, saying, “Yes,
very well, thank you. I’m amazed you remember something so far back.”
“You think we give out awards like that to just anyone?” he says ear-
...
old, I say with a small smile, “The Corps really straightened me out—I
...
```
always kept a cool head. You’ve built a reputation as someone who is de-
...
Priority: Highest
Subject: AC TION NEEDED: payroll run is failing
...
guessing at people’s paychecks, as well as paying people who were termi-
nated, and not paying people who were newly hired.
...
Chapter 2 • 29
```
“Oh, man. A financial reporting error?” Dick mutters. “We’ll need ap-
...
tion. She does all of the scheduling, so people are always lobbying her
...
```
that it was probably something in the timekeeping applications support-
ing each plant.
...
pacting incidents that are so disruptive, we typically drop everything
...
fense, pal, but aren’t you a little out of your league? You’ve managed the
...
“Sarah is definitely going to be one unhappy camper. You know, sud-
...
Chapter 3 • 39
```
A developer jamming in an urgent change so he could go on va-
...
scene and we’re Scotland Yard. The SAN is no longer a suspect, but un-
...
```
40 • The Phoenix Project
```
line for years. They never follow our process, and it always causes prob-
...
identifiable information like SSNs—that’s Social Security numbers, ob-
...
hottest, fastest gear out there. You’re supposed to support 250 transac-
...
tems, applications, Layer 7 switching—the whole wad of crap. It’s going
...
calations. You can probably guess who that is...”
I groan. “Brent?”
...
Chapter 4 • 59
```
When I get back to my cubicle, Ellen is at my desk, bending over my lap-
top, writing a note.
...
Priority: Highest
Subject: Mandatory C AB meeting Friday, 2 PM
Today, I attended the weekly C AB meeting. I was extremely
...
‘management response letter.’ You need to investigate each of these find-
...
Chapter 5 • 67
```
the upcoming Phoenix rollout. Which of these findings are the most im-
...
sponsible for protecting? You’ll personally apologize to the thousands
...
curity reviews. You probably should talk to Chris and Sarah right away.”
...
She types on her laptop. “You just want a list of organizational com-
...
Chapter 6 • 79
```
“Second, John is right. We spent yesterday morning with our audi-
...
plication catalog and change management database current? You think
...
nuts. I say, “You know, my wife and I are huge fans of you guys. Back
...
86 • The Phoenix Project

Taking another look at him, I correct myself—I’m pretty sure a deliv-
...
and ‘process.’ Your problem right now is that you obviously don’t actu-
ally know what ‘work’ is.”
I stare at him.
...
88 • The Phoenix Project

“What then, exactly, is your definition of ‘work?’ ” he asks, with a gen-
...
If you stand here long enough, you can actually see all the WIP, t h a t’s
...
ent places, they all agree on one thing: WIP is the silent killer. Therefore,
...
Chapter 8 • 95
```
Steve just nods and replies happily, “Let’s see if it changes their im-
...
sionate manager who is dispassionately struggling to decide how to best
...
get cash-flow positive soon. You have some of the most expensive re-
sources in the entire company. You have to use what you’ve got.”
...
“You may think that with three thousand employees, six more em-
...
to handle the angry phone calls from the business, saying that some cus-
tomers were allergic to the foam we used.”
...
In reality, any Sev 1 outage automatically qualifies as a very big prob-
...
```
106 • The Phoenix Project
```
my mouth to hide my angry scowl and to keep me from saying some-
thing rash.
...
110 • The Phoenix Project

Looking at all the change cards on the wall, I realize that I’m look-
...
“Usually it’s other IT people who are having problems fixing some-
...
“Okay, let’s give it a try,” she says. “You know, we’ve got the ‘stick’ ap-
...
a mistake?”
She says after a moment, “You know, that’s an interesting ques-
...
122 • The Phoenix Project

I listen to Wes and Patty brainstorm ideas to reduce yet another de-
...
body on the phone, “Yes, we copied the file that you gave us... Yes, it’s
...
Chapter 12 • 129
```
what’s coming over. We need better visibility and someone to keep peo-
...
up by the tomorrow 8 AM deadline. There is SIGNIFIC ANT RISK that this
...
goals and avert what I believe will be a NEAR- CER TAIN disaster.
...
```
132 • The Phoenix Project
```
Suddenly, I panic for a brief moment that I haven’t told Paige anything
...
responsible.”
“No,” Steve responds quickly and gravely. “You are ultimately ac-
...
Chapter 13 • 143
```
“No, no, no. That’s even worse!” he says. “Remember, we’re not al-
...
hear that just now. You’ve got to figure out how to destroy all this pro-
hibited data!”
...
they could help do some of the legwork around estimating the remedia-
tion effort? Or if you need it, we could even put them into the technical
...
```
156 • The Phoenix Project
```
```
But is it worth having to deal with Steve’s raving demands for the im-
...
```
160 • The Phoenix Project
```
```
for the past week. “I know you were concerned about when sixty per-
...
thought: You’ve started to take steps to stabilize the operational environ-
...
identify the constraint. You’ve done that, so congratulations. Keep chal-
...
Chapter 15 • 163
```
because if you’re wrong, nothing you do will matter. Remember, any im-
...
I groan. “Brent.”
“Yep,” he says. “Without solving your Brent problem, you’ll just be in-
...
Priority: Highest
Subject: AC TION NEEDED: Potential $50MM cash shortfall due to IT failure
```
...
SYSTEM. WE C AN’ T E VEN RE TRIE VE THEM TO MANUALLY SEND
INVOICES BY E-MAIL!
...
age just seconds before. I take a deep breath before I hit the button to
answer the call.
I say, “Bill here.”
...
172 • The Phoenix Project

being so professorial about this, but we’ve got a wildfire that’s out of con-
...
tems are now completely down, too. No one can get inventory levels in
...
filled your end of the bargain. You’ve been a straight shooter, and you’ve
...
other as people. You’ve learned a bit about me and my vulnerabilities.
...
```
192 • The Phoenix Project
```
trust. Lencioni teaches that showing vulnerability helps create a foun-
dation for that.
...
Wes grumbles loudly, “Yeah, well, that’s what happens when the air-
...
```
194 • The Phoenix Project
```
compliance, shouldn’t he be here, too? And isn’t he a part of the IT lead-
ership team as well?”
...
ric, Steve. Very moving. But you know what your problem is? You guys
...
what capacity you actually have. You’re like the guy who is always writ-
...
thousand changes stuck in the system, with no apparent way of ever get-
ting them completed?”
...
est, with the tie-breaker being who can escalate to the most senior ex-
ecutive. Except when they’re more subtle. I’ve seen a bunch of my staff
always prioritizing a certain manager’s requests, because he takes them
out to lunch once a month.”


206 • The Phoenix Project
...
tumn. The leaves on the trees are starting to turn orange and brown, and
...
tect that constraint from being hit by unplanned work. You’re asking
...
“What?” I nearly shout. “How can it not be Brent? You even congratu-
...
I nod, unable to resist groaning. “You’re right. I’ve heard my manag-
...
“Good,” he says. “You’re standardizing Brent’s work so that other peo-
...
“Yes.” He continues, “Let’s start with your first question. Which proj-
...
to troubleshoot and fix. You’ve already identified the constraint, ex-
...
“You know what your problem is, Jimmy?” Erik says, pointing his fin-
ger at him. “You are like the political commissar who walks onto the plant
...
out you having to do anything at all. You are like the plumber who
...
222 • The Phoenix Project

hell-bent on making it go out of business even faster, with all your ill-
...
I stare at John’s binder, not quite believing he discarded it so care-
...
pretty well. For this server setup example, we know that it’s a work cen-
ter that gets hit by almost every business and IT project. If we nail this
...
the tools they need to do their jobs is one of our primary responsibili-
ties. I’m not saying I don’t believe you, but let’s keep these time estimates
...
```
234 • The Phoenix Project
```
“Sounds about right,” Wes says. “You just need to create a new virtu-
...
teams! You need the OS and all the software packages, license keys, ded-
...
ple off on three-hour tours, and months later, we wonder why none of
them come back.”
Patty says, “I wonder if we could create a kanban lane for each of
these ‘tasks?’ ”
“Yes, that’s it,” I say. “Erik was right. You’ve just found a big pile of re-
...
“Good point,” Wes grunts. “You know, it’s odd. So many of these prob-
...
Chapter 23 • 237
```
Patty says, “You know, deployments are like final assembly in a man-
...
provide minute-by-minute control. She says, “We need fast and effec-
tive handoffs of any completed work to the next work center. If neces-
...
“A t MRP-8, they have a ‘water spider’ role that does exactly that,” she
...
agers accountable, ensure that they have the skills necessary to succeed,
and help make sure that complex initiatives always have the right stake-
...
“Th at’s a fun day for me. We can plan and plan until the cows come
...
```
```
you wonder whether the problem is the economy, our strategy, our man-
...
better.”
“You’re right,” I say. “I don’t think Dick realizes how much his mea-
...
him continue, “Your mission is twofold: You must find where you’ve un-
...
on-time delivery KPIs are going to take a dive, when trucks start get-
...
254 • The Phoenix Project

IT risks jeopardize business performance measures, you can start mak-
...
basket, putting them in the recycling bin. “You’re listed as the owner
...
Chapter 26 • 257
```
“Okay, it’s your nickel...” he says. “If you want to talk about sales fore-
...
```
260 • The Phoenix Project
```
systems, we could do this. But we can’t, because the data are almost al-
ways wrong.”
...
ally do A/B testing of offers, finding the ones that our customers jump
at. When we find out what works, we’ d replicate it across our entire cus-
...
stores. You’re keeping the right products in the stores, and the cam-
...
not giving us a return. Dick expects that on average, our R&D invest-
...
ther the IT systems or data; and in the fourth column, we’ll write down
...
in the room by any stretch. But, if we’re so important, why are they try-
ing to outsource all of us? Face it, we’ve been moved from one foster
...
ing, percentage of valid SKUs created by Marketing, and so forth.
...
ple get dragged into fire drills at the last minute by managers trying
to achieve those measurements—just like Brent was pulled in to help


```
268 • The Phoenix Project
```
...
Erik. You know, five years ago, we used to have our CIO attend our quar-
...
“Yes, sir,” I say. “The operational risks posed by IT need to be man-
...
ising some fantastic news. He says effusively, “You guys did fantastic
...
```
276 • The Phoenix Project
```
process or skill. Whether it’s calisthenics, sports training, playing a mu-
...
all our interactions with Erik. It will be interesting to see if we can re-
train them.
...
Chapter 28 • 277
```
innocuous but the others are more serious: she has contracted a ven-
...
278 • The Phoenix Project

Patty snorts. “If Steve were a woman, I’d say that he’s attracted to dan-
...
tion. All the tests had finally passed, and Chris and William gave the
...
trolling the flow of work from Development to IT Operations. You’ve
...
and the worst kind, too. Your deployments are causing unplanned re-
...
ance. You get there by continually reducing batch sizes.
...
Wall Street. All our hopes depend on completing Phoenix. You’re tell-
...
a S WAT team by detaching a small squad from the main Phoenix team,
...
dubious. Eventually Wes says, “You know, this just may work.” When ev-
...
ogy and bit of process knowledge they have to ensure work is performed
...
Chapter 30 • 295
```
“So when you run around screaming, ‘Oh no! We don’t have environ-
...
chine to manufacture multiple different car models simultaneously. You
...
“You’ve got to figure out how to decrease your changeover time and en-
...
can achieve amazing things. They also knew that until code is in pro-
duction, no value is actually being generated, because it’s merely WIP
...
to automate the entire environment creation process. You need a deploy-
ment pipeline where you can create test and production environments,


298 • The Phoenix Project
...
enough?”
“You think IT Operations is rocket-science compared to manufac-
...
It’s 12:13 p.m. when I walk into the S WAT team kick-off meeting. My hair
...
“You’ve nailed it. William can probably relate to these problems: the re-
...
wand. You’re at the front of the line. Tell me how you’d design the manu-
...
```
306 • The Phoenix Project
```
“And you know,” he continues, “I want this so much, I’d happily vol-
...
The next two weeks fly by with the S WAT team activities taking up much
...
The first challenge: to name the S WAT team project. We couldn’t keep
...
```
310 • The Phoenix Project
```
While I’m in the middle of a budgeting meeting, Wes calls. “We’ve got a
big problem.”
...
“I don’t know,” he replies. “Trust me, I don’t want to be here. I hate air-
...
```
```
I remember when I led the acquisition integration team when we ac-
...
Chapter 33 • 315
```
company chairman, I call Steve, who is obviously furious at Sarah’s ap-
...
geted for twenty of the fastest servers we could find. You’d need over a
...
```
316 • The Phoenix Project
```
```
will call her peers in the industry to see if any of them have done this be-
...
Subject: First Unicorn promotion campaign: UNBELIE VABLE!
...
times, too. With Phoenix, we only rehearsed and practiced doing the de-
ployments once per quarter. Just in the last five weeks, we’ve done over
twenty Unicorn code and environment deployments. It almost feels rou-
...
320 • The Phoenix Project

partly because we’re so used to taking a month to turn around applica-
...
Chapter 34 • 323
```
By Monday morning, the situation has stabilized. Which is good, be-
...
this team.”
Wes snorts. To Sarah, he says, “You’re kidding, right? Do you under-
...
```
330 • The Phoenix Project
```
loud barking and then the sounds of a very large dog slipping on a hard-
...
open position for the CIO for months. You’ve been a part of that inter-
...
He continues, “This is going to take a while to explain. You were ev-
...
Chapter 35 • 333
```
IT. Any COO who doesn’t intimately understand the IT systems that ac-
...
334 • The Phoenix Project

including Steve’s startling offer to go on a three-year training plan to be-
come the next COO.
...
nize the bronzed laptop. “You know, even though I give you a fifty-fifty
...
```
342 • The Phoenix Project
```
Humble for their groundbreaking and seminal contributions of show-
...
```
L e a hy, CFO of Transdermal Corporation; Jeff Hughes, VP of Radiant
...
ing. You have been an instrumental part in my continued quest to keep
...
ganization, as well as the organization it serves. Left unchecked, the con-
flict increases time to market for Development, creates longer and more
...
adopting a set of techniques that we now call DevOps, and they are rou-
...
portant (and often the primary) means of customer acquisition within
most organizations.
...
times more frequently, and the time required to go from “code commit-
...
they were twice as likely to be completed successfully (i.e., without caus-
ing a production outage or service impairment), and when the change
...
350 • The Phoenix Project

features more quickly, while providing world-class levels of reliabil-
...
ganizational performance as well: they were two times more likely to
exceed profitability, market share, and productivity goals, and there are
hints that they have significantly better performance in the capital mar-
kets, as well (as Erik predicted in the last chapter, when he wanted to
...
thousands of code deploys per day), while preserving world-class stabil-
ity, reliability, availability, and security.
...
work flows smoothly through the entire value stream, speeding up auto-
...
lematic code from going into production and to enable code to quickly
...
into the system of work to enable organizational learning and improve-
ment. Everyone dedicates time to putting those lessons into prac-
tice and paying down technical debt. Everyone values nonfunctional


```
Resource Guide • 351
```
requirements (e.g., quality, scalability, manageability, security, operabil-
...
want, deploying code that doesn’t work, or fixing something that isn’t ac-
...
the code and environment will operate as designed, and that we are al-
...
Because at product launch time, the code delivering the new functional-
ity is already in production. Months prior to the launch, Development
...
ments in production, testing our business hypotheses for every feature
...
DevOps shows how we optimize the IT value stream, converting busi-
ness needs into capabilities and services that provide value for our
customers.
...
Resource Guide • 353
```
Because one can’t simultaneously increase and decrease the inven-
...
Resource Guide • 355
```
trust combined with small batch sizes and smaller, more frequent soft-
...
tory happened at Agile conferences, in addition to the incredibly vibrant
...
frastructure as code” pioneered by Dr. Mark Burgess, as well as continu-
ous integration and continuous deployment (pioneered by Jez Humble
...
ical management movements, such as Lean Startup, Innovation Culture,
...
stream work centers, and to constantly optimize for the global goals (as
...
deployment, creating environments on demand, limiting work in pro-
cess, and building safe systems and organizations that are safe to change.
...
one can see whether code and environments are operating as designed
and that customer goals are being met.

**The Third Way** is about creating a culture that fosters two things: con-
tinual experimentation, which requires taking risks and learning from
...
and is operating in production as designed. (Note that Agile is not a pre-
requisite for adopting DevOps.)

**DevOps replaces ITIL**
Although some may view DevOps as backlash to ITIL (the IT Infrastructure
Library) or ITSM (IT Service Management), DevOps and ITIL are com-
...
cesses require automation, specifically around the change, configuration,
...
ments and maintain service levels. This merely means that Development
...
waiting for IT Operations to complete the work, many of these activi-
...
Although many of the DevOps success stories take place in organiza-
tions using software such as the LAMP stack,10 organizations are imple-
...
ganizations will come up with countless reasons why they cannot adopt
...
- LinkedIn, six months after their successful IPO in 2011, strug-
    gled with problematic deployments so painful that they launched
...
- Facebook, in 2009, was at the breaking point for infrastructure
    ...
    ments were becoming increasingly dangerous, and staff were con-
    tinually firefighting. Jay Parikh and Pedro Canahuati started their
...
there is no easy way to find out how much of capacity is already com-
mitted to internal projects.
...
JIRA, or an Agile planning tool for Development). The fact that two sys-
tems exist to track work for two different parts of the value stream can
create problems, especially when handoffs are required.
Incidentally, in some dedicated teams that own both the feature de-
velopment and service delivery responsibilities, all work lives in the
...
and therefore, anytime we required work from him, the work just lan-
guished in queue, never worked on without expediting or escalating.


364 • The Phoenix Project
...
astating consequences of this property on lead times for the commit-
ments they were making to the project management office:
...
the ‘percentage of time idle.’ In other words, if a re-
...
as “touch time”) was only 0.16% of the total lead time (thirty minutes di-
vided by sixty-three hours). That means for 99.8% of our total lead time,
...
of overloaded IT workers and the fallacies of using typical project man-
agement techniques for IT Operations.
...
homage to The Goal. We attempted to mirror most of the book struc-
ture and plot elements, while making it contemporary, relevant, and, I


368 • The Phoenix Project
...
then the heat treat ovens, and then the constraint becomes market de-
mand. In The Phoenix Project, the constraint was initially Brent because
he was always dealing with unplanned work, then the application de-
ployment process, and then the constraint moved outside the organiza-
tion because the needed MRP application support was outsourced.
In Dr. Goldratt’s following book, It’s Not Luck, he describes what he
called the Thinking Processes, which is a fantastic (but somewhat inac-
cessible and often very slow) methodology of identifying core, chronic
conflicts, capturing the current reality, describing the desired future re-
ality, and various planning techniques to increase the likelihood of get-
...
mend Dr. H. William Dettmer’s textbook, The Logical Thinking Process,
although it is not light reading. And many shortcuts have been devel-
...
- Fear of conflict—seeking artificial harmony over constructive
    passionate debate
- Lack of commitment—feigning buy-in for group decisions cre-
    ates ambiguity throughout the organization
...
ing vulnerability to each other and enabling the next step, which is to
stop fearing conflict. Jim set the tone of the honesty and candor he de-
manded from everyone, and, trust me, it changed how we behaved and
...
of not being able to have candid discussions about problems that ev-
eryone knows about, but is unwilling to confront, is incredibly high.
...
ing him, as well as taking his three-day course, “Improvement Kata and
...
ecutives. He describes that stage of his journey as capturing and codi-
fying the observed Toyota practices that led to their extraordinary and
market-leading performance.
However, when he looks back at that phase of his career, he’ll charac-
terize it as merely teaching people how to mimic the behaviors observed
...
which frames the thought process and culture that must exist to en-
able the Lean PDCA cycle (Plan, Do, Check, Act). I believe that this is
one of the most extraordinary contributions to the world of process
improvement.


372 • The Phoenix Project
...
mains of sports training, learning to play a musical instrument, military
Special Forces training, and now in modern manufacturing. This forms
the basis of Erik’s Third Way. He explains, “It’s about how to create a cul-
ture that simultaneously fosters experimentation, learning from failure,
...
per year, but then get marginalized from daily operations the remain-
der of the year.
...
Resource Guide • 373
```
observing how a certain work center that was able to decrease the num-
...
jecting faults into the production environment (embodied in tools
...
ery techniques extend these processes all the way into the production
environment.
...
374 • The Phoenix Project

Without automated builds, you can’t have automated testing, and with-
...
Development to IT Operations production deployment process was al-
most precisely what he and Farley did in their book. Awesome.
...
build the validation tests necessary to either prevent failures in produc-
tion, or, at the very least, detect and correct them quickly (e.g., the tran-
sition from manual process reviews to automated tests, especially in the
...
Nygard in his fantastic book, Release It!: Design and Deploy Production-
Ready Software.24
...
into the software/service development lifecycle, the best posture of com-
pliance (e.g., fewest number of repeat audit findings), and amazingly, the
...
made their “good to great” IT transformations, and codified this trans-
formation in the books The Visible Ops Handbook: Implementing ITIL
...
376 • The Phoenix Project

complete without. I loved this book when I first read it in 2000, as it cat-
...
scriptive, ordered set of steps (projects) to replicate the outcomes we ob-
served in high performers. (Incidentally, this is what we’re attempting to
...
sonal productivity book than a book about complex value streams. In
...
endars for keeping commitments, and the theory of filing and contex-
tual TODO lists, Benson and Tonianne discuss the need to visualize all
...
- Dissatisfaction with lateness and long lead times forced IT man-
    agement to do “more work estimation,” forcing managers to
    spend all their time building PowerPoints (because business con-
    clusion was that they didn’t do a good job estimating), instead of
    doing real work
...
enty percent of all the team’s time was blocked on other people—in
...
items per month, and at that rate, it would require three years to com-
plete all that work. Here were the countermeasures that he put into place
...
378 • The Phoenix Project

```
their ticketing system, so they used that. This resulted in an im-
...
- Their lead time went from 155 days to twenty-two days. Lead times
    ...
    days (Wow!).
- Their next surge in productivity came from increasing the num-
    ber of developers, because for every two days of Dev work, it re-
...
As Dumitriu said, “We succeeded because we focused relentlessly on re-
ducing lead time, as opposed to Dev & Test optimizing for themselves.”
...
380 • The Phoenix Project

NOTES

1. Code deployment lead time is the time required to go from “change com-
mitted into version control” by Development to “successfully running in
production.”
...
[http://puppetlabs.com/2014-devops-report.](http://puppetlabs.com/2014-devops-report.)
5. Along with the adoption of Lean principles, other techniques widely ad-
opted included the Toyota Production System, Lean Manufacturing, Theory of
...
accessed July 14, 2014, [http://itrevolution.com/the-convergence-of-devops/.](http://itrevolution.com/the-convergence-of-devops/.)
...
accessed July 14, 2014, [http://velocityconf.com/velocity2009/public/schedule](http://velocityconf.com/velocity2009/public/schedule)
/detail/7641.
...
20, 2006, [http://queue.acm.org/detail.cfm?id=1142065.](http://queue.acm.org/detail.cfm?id=1142065.)


```
Resource Guide • 381
```
13. Raffi Krikorian, “Real-Time Systems at Twitter,” (Velocity Conference pre-
sentation), Slideshare website, June 26, 2012, [http://www.slideshare.net](http://www.slideshare.net)
...
[http://www.businessweek.com/articles/2013-04-10](http://www.businessweek.com/articles/2013-04-10)
...
Slideshare website, October 4, 2012, [http://www.slideshare.net/mcdonnps](http://www.slideshare.net/mcdonnps)
...
(OmniTI Surge Conference presentation), September 12, 2013, [http://surge.](http://surge.)
...
grams now exist through the Theory of Constraints International Certification
...
(course), Washington State University website, accessed July 15, 2014, [http://](http://)
public.wsu.edu/~engrmgmt/holt/em526/em526syl.htm; EM 530 “Applications
in Constraints Management” (course), Washington State University website, ac-
cessed July 15, 2014, [http://public.wsu.edu/~engrmgmt/holt/em530/index.htm.](http://public.wsu.edu/~engrmgmt/holt/em530/index.htm.)
19. See “Teamwork,” the Table Group website, accessed July 15, 2014, [http://](http://)
[http://www.tablegroup.com/teamwork.](http://www.tablegroup.com/teamwork.)
20. See “Personal History Exercise,” the Table Group website, accessed July 15,
2014, [http://www.tablegroup.com/imo/media/doc/Personal%20Histories](http://www.tablegroup.com/imo/media/doc/Personal%20Histories)
%20Exercise.pdf.
...
382 • The Phoenix Project

goods brought by American and Japanese soldiers, these tribes were baf-
fled when the war and supply deliveries ended. In an effort to bring back the
...
2012, [http://itrevolution.com/the-convergence-of-devops/.](http://itrevolution.com/the-convergence-of-devops/.)
...
(blog), August 23, 2009, [http://www.personalkanban.com/pk/primers](http://www.personalkanban.com/pk/primers)
...
Certification Organization, November 2005, [http://images.itrevolution.com](http://images.itrevolution.com)
